...
% make it one infinitely long page
...
\advisor     {Dr. Kerstin Lenhof, M. Sc. Lea Eckhart}
...
\loadchapter{Intro}{Introduction}
\loadchapter{Bio}{Biological Background}
\loadchapter{Math}{Mathematical Methods}
\loadchapter{Mats}{Materials}
\loadchapter{Impl}{Implementation}
